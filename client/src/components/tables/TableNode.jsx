...
const STATUS_STYLES = Object.freeze({
  ...
  running: {
    shell: 'border-emerald-500 bg-emerald-100 text-emerald-950 shadow-[0_16px_34px_-14px_rgba(22,185,121,.62)] ring-2 ring-emerald-200/70',
    accent: 'bg-emerald-500',
    badge: 'bg-emerald-100 text-emerald-800',
    Icon: Clock3,
  },
  paused: {
    shell: 'table-paused border-slate-500 bg-slate-100 text-slate-900 shadow-[0_14px_30px_-16px_rgba(100,116,139,.5)]',
    accent: 'bg-slate-500',
    badge: 'bg-slate-200 text-slate-700',
    Icon: CirclePause,
  },
  warning: {
    shell: 'table-warning border-amber-500 bg-amber-100 text-amber-950 shadow-[0_16px_34px_-12px_rgba(245,166,35,.65)] ring-2 ring-amber-200/80',
    accent: 'bg-amber-500',
    badge: 'bg-amber-100 text-amber-900',
    Icon: AlertTriangle,
  },
  overtime: {
    shell: 'table-overtime border-red-600 bg-red-100 text-red-950 shadow-[0_18px_38px_-12px_rgba(239,68,68,.7)] ring-2 ring-red-300/80',
    accent: 'bg-red-500',
